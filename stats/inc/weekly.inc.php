...
*/	
	...
	for ($i = 0; $i < 7; ++$i) {
		$oggi = $varie['days'][$i];
		$return .= "<tr onmouseover=\"setPointer(this, '$style[table_hitlight]', '$style[table_bgcolor]')\" onmouseout=\"setPointer(this, '$style[table_bgcolor]', '$style[table_bgcolor]')\">" . "<td bgcolor=$style[table_bgcolor] align=\"right\" width=\"150\"><span class=\"tabletextA\">$oggi</span></td>" . "<td bgcolor=$style[table_bgcolor] align=\"right\"><span class=\"tabletextA\"><b>$hits[$i]</b></span><br><span class=\"tabletextA\"><b>$accessi[$i]</b></span></td>" . "<td bgcolor=$style[table_bgcolor]><span class=\"tabletextA\"><img src=\"templates/$option[template]/images/style_bar_1.png\" width=\"" . ($hits[$i] / max($hits_max, 1) * 250) . "\" height=\"7px\"> (" . round($hits[$i] * 100 / max($hits_tot, 1), 1) . "%)</span><br><span class=\"tabletextA\"><img src=\"templates/$option[template]/images/style_bar_2.png\" width=\"" . ($accessi[$i] / max($hits_max, 1) * 250) . "\" height=\"7px\"> (" . round($accessi[$i] * 100 / max($accs_tot, 1), 1) . "%)</span></td></tr>";
	}
	$return .= "<tr><td height=\"1\" bgcolor=$style[table_title_bgcolor] colspan=\"3\" nowrap></td></tr>" . "<tr><td bgcolor=$style[table_bgcolor] colspan=\"3\" nowrap><span class=\"tabletextA\"><center><img src=\"templates/$option[template]/images/style_bar_1.png\" width=\"7\" height=\"7px\"> $string[hits] <img src=\"templates/$option[template]/images/style_bar_2.png\" width=\"7\" height=\"7px\"> $string[visite]</span></center></td></tr>" . 
