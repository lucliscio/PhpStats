...
***/
   ...
   for($i=0,$tot=count($search_engines_def);$i<$tot;++$i){
	...
	if($standardse)
      ...
      if($forcedDomain && ($tmpdomain=='www' || $tmpdomain=='com' || $tmpdomain=='net' || $tmpdomain=='org')) $domain=$forcedDomain;//se � presente il dominio forzato lo uso al posto di com,org,net
